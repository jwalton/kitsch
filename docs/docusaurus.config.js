...
const remarkKitschPromptPreview = require('./src/remark/kitschPromptPreview').default;

/** @type {import('@docusaurus/types').Config} */
const config = {
  title: 'Kitsch Prompt',
  tagline: 'Cross-platform shell prompt',
  url: 'https://kitschprompt.com',
  baseUrl: '/',
  onBrokenLinks: 'throw',
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Jason Walton`,
      },
      prism: {
