...
Running the script will install kitsch on your system in /usr/local/bin, and display instructions on how to try it out and how to setup your shell configuration files. On Mac, you can also install via [Homebrew](https://brew.sh/):
